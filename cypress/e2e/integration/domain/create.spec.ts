...
describe('Test Domain Page', () => {
  ...
  it('creates the default domain with cert from fixture file upload', () => {
    return cy
      .env(['PROVISIONING_CERT', 'PROVISIONING_CERT_PASSWORD'])
      .then(({ PROVISIONING_CERT, PROVISIONING_CERT_PASSWORD }) => {
        ...
        const certFixtureData: Cypress.FileReference = {
          ...
          contents: Cypress.Buffer.from(PROVISIONING_CERT, 'base64')
        }
