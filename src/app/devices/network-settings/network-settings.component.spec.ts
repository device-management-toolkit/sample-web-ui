...
describe('NetworkSettingsComponent', () => {
  ...
  it('disables the password field when using EAP-TLS protocol', () => {
    component.addNewWirelessProfile()
    component.wirelessProfileForm.patchValue({
      authenticationMethod: 'WPA2IEEE8021x',
    ...
    expect(component.wirelessProfileForm.controls.ieee8021xPassword.disabled).toBeTrue()
    expect(component.wirelessProfileForm.controls.ieee8021xPassword.hasError('required')).toBeFalse()
  })

  it('enables the password field when using PEAP-MSCHAPv2 protocol', () => {
    component.addNewWirelessProfile()
    component.wirelessProfileForm.patchValue({
      authenticationMethod: 'WPA2IEEE8021x',
    ...
    expect(component.wirelessProfileForm.controls.ieee8021xPassword.enabled).toBeTrue()
    expect(component.wirelessProfileForm.controls.ieee8021xPassword.hasError('required')).toBeTrue()
  })

  it('requires a password when switching from EAP-TLS to PEAP-MSCHAPv2', () => {
    component.addNewWirelessProfile()
    component.wirelessProfileForm.patchValue({
      authenticationMethod: 'WPA2IEEE8021x',
      ieee8021xAuthenticationProtocol: 0 // EAP-TLS
  ...
  it('disables the password field when switching from PEAP-MSCHAPv2 to EAP-TLS', () => {
    component.addNewWirelessProfile()
    component.wirelessProfileForm.patchValue({
      authenticationMethod: 'WPA2IEEE8021x',
      ieee8021xAuthenticationProtocol: 2, // PEAP-MSCHAPv2
      ieee8021xPassword: 'secret123'
    })
  ...
  it('does not require a password for EAP-TLS even when PEAP was previously selected', () => {
    component.addNewWirelessProfile()
    component.wirelessProfileForm.patchValue({
      authenticationMethod: 'WPA2IEEE8021x',
      ieee8021xAuthenticationProtocol: 2, // PEAP-MSCHAPv2
    ...
    expect(component.wirelessProfileForm.controls.ieee8021xPassword.disabled).toBeTrue()
    // Password field should not cause form to be invalid
    expect(component.wirelessProfileForm.valid).toBe(false) // Still invalid due to other required fields
  })
})
