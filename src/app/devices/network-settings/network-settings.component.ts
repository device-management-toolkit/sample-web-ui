...
import { Component, OnDestroy, OnInit, inject, signal, input, ChangeDetectorRef, WritableSignal } from '@angular/core'
...
export class NetworkSettingsComponent implements OnInit, OnDestroy {
  ...
  public saveWiredSettings(): void {
    ...
    this.devicesService
      ...
      .pipe(
        catchError((err) => {
          this.showError(this.translate.instant('network.wired.updateError.value'))
          return throwError(() => err)
        }),
        finalize(() => {
  ...
  public saveWirelessSettings(): void {
    ...
    this.devicesService
      ...
      .pipe(
        ...
        catchError((err) => {
          this.showError(this.translate.instant('network.wireless.updateError.value'))
  ...
  public saveWirelessProfile(): void {
    ...
    request
      .pipe(
        catchError((err) => {
          this.showError(this.translate.instant('network.wirelessProfile.saveError.value'))
          return throwError(() => err)
        }),
        finalize(() => {
    ...
    dialogRef
      ...
      .subscribe((confirmed) => {
        ...
        this.devicesService
          ...
          .pipe(
            catchError((err) => {
              this.showError(this.translate.instant('network.wirelessProfile.deleteError.value'))
              return throwError(() => err)
            }),
            finalize(() => {
              this.isSavingWirelessProfile.set(false)
